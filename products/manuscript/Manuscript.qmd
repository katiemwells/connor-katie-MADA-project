...
To determine what the best predictor of vaccine administration in our dataset was, we used a tree-based machine learning model. Our code was modeled after the ‘tidymodels’ package framework; it used cross-validation and split the cleaned data into training and testing sets for comparison. We also created a null model to compare our final model to to evaluate its performance. The exact steps can be found in the ‘analysis.qmd’ file. 
