...
Question: What factors (like region) influenced COVID-19 vaccine distribution across the US? Hypotheses: H0 - There is not a difference in COVID-19 vaccine (across manufacturers) popularity across all the regions in the United States. HA - There is differences in COVID-19 vaccine (manufacturer) popularity across the regions in the United States.
...
Here are the main results from our initial fitting analysis. Each is displayed in a tibble. Note: we may not keep all of these fits in our final project but we calculated them all to view the results. Further checking of the models can be found in the 'fitting.qmd' in the 'analysis_code' folder.

###reminder for katie later: use kable and save tibbles as RDS!!!!!
